						...
						?>
								<div style="width:590px;height:920px;margin:10px auto;page-break-after:always;">
									...
									<div style="height:238px;border:1px solid black">
										...
										<div class="sectionBlocks" style="width:100px;height:79px;" >
											<div>Section - A</div>
										...
										<div class="sectionBlocks" style="width:160px;height:79px;">
											<div>Section - C</div>
											<div>
										...
										<div class="sectionBlocks" style="border-right:none;width:225px;height:79px;">
