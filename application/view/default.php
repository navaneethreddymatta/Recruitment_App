			...
			<div id="page-content"  style="min-height: 689px;" >
				...
				<div class="block">
					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-8 col-sm-8">
							<div id="error" class="alert alert-info" >
								<h3 align="center">Welcome to Flexeye Recruitment! </h3> 
								<h4 align="center">Thank you for visiting us. Fill in your details for registration and keep a note of your registration ID for further reference. Please contact HR for any issues.</h4>
								<h4 align="center">All the Best!
								</h4>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2">
					...
					<div class="row">
						...
						?>
								<a id="regNew" class="btn btn-lg btn-primary btn-block disabled" href="index.php?op=new">Register New Candidate <i class="fa fa-arrow-right"></i></a>
						<?php
							}
							else{
						?>
								<a id="regNew" class="btn btn-lg btn-primary btn-block" href="index.php?op=new">Register New Candidate <i class="fa fa-arrow-right"></i></a>
						<?php
							}
						?>	
							<a class="btn btn-lg btn-primary btn-block" href="index.php?op=search2">Show Status <i class="fa fa-arrow-right"></i></a>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4">
						</div>
					</div><br/>
