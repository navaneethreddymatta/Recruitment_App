<div id="newstatusdef" class="block">
	<!-- Form Validation Example Title -->
	<div class="block-title">
		<h2><strong><?php if(count($settingFor)>0){echo "Status Definition Information";} else {echo "New Round Information";}?></strong></h2>
	</div>
	<!-- END Form Validation Example Title -->
	<!-- Form Validation Example Content -->
	<form class="form-horizontal" method="post" action="" id="statusform-validation" novalidate="novalidate">
		<div class="row">
			<?php if(count($settingFor)>0){?>
			<div class="col-md-12">
				<div class="form-group">
					<div class="col-md-12">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-shield"></i></span>
							<input type="text" placeholder="Please enter Display Name" class="form-control input-lg" name="val_displayname" id="val_displayname" value="<?php if(count($settingFor)>0){ echo $settingFor->displayName;}?>">							
						</div>
					</div>
				</div>
			</div>
		...
		<div class="form-group form-actions">
			<div class="col-md-8 col-md-offset-4">
				<input type="hidden" value="newstatusdef" name="val_form" id="val_form">
